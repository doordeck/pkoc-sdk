...
{
    public static let shared = GrpcWebClient()
    ...
    public func call(servicePath: String, method: String, body: Data) async throws -> Data
    {
        guard let url = URL(string: baseURL + servicePath + "/" + method) else
        {
    ...
    public func parseDataFrame(_ responseData: Data) throws -> Data
    {
